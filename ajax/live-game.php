...
// Prepare game variables via controller and extract returned data for local scope
$gameData = game_prepare_live($gameId ?? ($GLOBALS['gameId_temp'] ?? null));
if (is_array($gameData)) extract($gameData);
